...
- `cron-reminders`: optional scheduled job that calls `/api/internal/jobs/reminders` with `x-cron-secret`. The worker also runs reminders every 15 minutes.
...
COMPANY_CONTACT_EMAIL=Conner.a1parola@gmail.com
COMPANY_CONTACT_PHONE=+14083062821
